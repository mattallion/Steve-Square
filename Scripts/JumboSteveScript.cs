...
public class JumboSteveScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (steve.score == 3)
        {
            ...
            gameObject.GetComponent<JumboSteveScript>().enabled = false; //change the green portion between <> to current script name
        }
