...
public class SpeedySteveScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (steve.score == 3)
        {
            ...
            gameObject.GetComponent<SpeedySteveScript>().enabled = false; //change the green portion between <> to current script name
        }
