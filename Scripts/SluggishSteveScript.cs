...
public class SluggishSteveScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (steve.score == 3)
        {
            ...
            gameObject.GetComponent<SluggishSteveScript>().enabled = false; //change the green portion between <> to current script name
        }
